    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                BlobClient blobClient = containerClient.GetBlobClient(user.FirstName.Replace(" ", "").ToLower() + "_" + user.LastName.Replace(" ", "").ToLower());
                using (var uploadFileStream = Input.File.OpenReadStream())
                {
